...
class caretakerinterface extends StatefulWidget {
  @override
  _caretakerinterfaceState createState() => _caretakerinterfaceState();
}

// ignore: camel_case_types
class _caretakerinterfaceState extends State<caretakerinterface> {
    ...
    return Scaffold(
      ...
      body:Stack(
        children: <Widget>[
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(910.0, 1590.0, 300.0, 300.0),
            size: Size(1440.0, 3040.0),
            child:
            Container(
              decoration: BoxDecoration(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(950.0, 2030.0, 300.0, 300.0),
            size: Size(1440.0, 3040.0),
            child:
            Container(
              decoration: BoxDecoration(
