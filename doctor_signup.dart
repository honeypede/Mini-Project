...
class doctor_signup extends StatefulWidget {
  @override
  _doctor_signupState createState() => _doctor_signupState();
}

// ignore: camel_case_types
class _doctor_signupState extends State<doctor_signup> {
  TextEditingController _nameController, _numberController, _qualController;
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      child:ElevatedButton(
                          onPressed: () {
                            duser = _nameController.text;
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => caretakerdoctor2(_nameController.text, _numberController.text, _qualController.text, user)),
                            );
                          },
                          child:Ink(
                            decoration: BoxDecoration(
