...
import 'package:telehealth/signup_screens/usersignup2.dart';
var name;

// ignore: camel_case_types
class usersignup1 extends StatefulWidget {
  @override
  _usersignup1State createState() => _usersignup1State();
}
                  ...
                  Container(
                      ...
                      child:ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => usersignup2(_nameController.text, _numberController.text)),
                            );
                          },
                          child:Ink(
                            decoration: BoxDecoration(
